...
{
	ShaderProgramSource source = ParseSahder(filename);
...
ShaderProgramSource Shader::ParseSahder(const std::string& filepath)
{
...
unsigned int Shader::CreateShaders(const std::string& vertexShader, const std::string& fragmentShader)
{
	...
	//you should calling glDetachShader ali onda ne mozemo debugirati kvalitetno
	glDeleteShader(vs);
	glDeleteShader(fs);
